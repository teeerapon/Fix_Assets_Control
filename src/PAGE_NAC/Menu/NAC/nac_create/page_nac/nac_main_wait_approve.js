...
export default function Nac_Main_wait() {
  ...
  const [serviceList, setServiceList] = React.useState([{ dtl_id: "", assetsCode: "", serialNo: "", name: "", date_asset: "", dtl: "", count: "", price: "", asset_id: "", image_1: "" }]);
      ...
      if (!des_department || !des_BU || !des_delivery) {
        ...
        if (!serviceList[0].assetsCode) {
          ...
          if (sum_price !== headers.sum_price || headers.source_userid !== source || headers.des_userid !== des_delivery) {
            ...
            if (data.UserCode === headers.create_by || (permission_menuID ? permission_menuID.includes(10) : null) === true) {
              const usercode = data.UserCode
              const nac_status = 10
  ...
  const handleSubmitComplete = async () => {
    ...
    if (selectNAC === 4 || selectNAC === 5 || selectNAC === 14 || !nameDes) {
      if (checkFullChecked.includes(0) === true || (serviceList.map((res) => res.image_1)).includes('') === true) {
  ...
  } else if (headers.nac_type === '2' || headers.nac_type === 2) {
    return (
      <React.Fragment>
                          ...
                          <StyledTableRow>
                            ...
                            <StyledTableCell align="center" style={{ "borderWidth": "0.5px", 'borderColor': "#aaaaaa" }}>
                              <React.Fragment>
                                ...
                                <LocalizationProvider LocalizationProvider dateAdapter={DateAdapter}>
                                  <DatePicker
