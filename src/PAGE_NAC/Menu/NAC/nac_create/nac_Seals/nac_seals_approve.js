  ...
  const handleSubmit_To_Approve = async () => {
    if (!sendHeader[0].source || !sourceName || !sourceLastName) {
      ...
      const reqUpdateStatus = {
        usercode: data.UserCode,
        nac_code: nac_code,
        nac_status: approveData.filter((res) => (res.approverid === data.UserCode) && res.status === 0 && (res.limitamount < result))[0] ? 2 : 3,
        nac_type: sendHeader[0].nac_type,
        source: sendHeader[0].source,
        sourceDate: sendHeader[0].sourceDate,
        des_delivery: sendHeader[0].des_delivery,
                        ...
                        <StyledTableRow>
                          ...
                          <StyledTableCell align="center">
                            <TextField
                              ...
                              inputProps={{ min: 0, style: { textAlign: 'right' } }}
                              value={res.priceSeals ? res.priceSeals : ''}
                              variant="standard"
                            />
                          </StyledTableCell>
                          <StyledTableCell align="center">
                          ...
                          <StyledTableCell align="start" colSpan={4}>
                            <TextField
                              ...
                              InputProps={{
                                ...
                                endAdornment: (
                                  <InputAdornment position="start">
                                    <Typography color="black" className='scaled-480px-TableContent' sx={{ ml: 2 }}>
                                      บาท
                                    </Typography>
                                  </InputAdornment>
                                ),
