...
async function Reported(credentials) {
  return fetch('http://49.0.64.71:32001/api/testGetBranch', {
    method: 'POST',
    headers: {
...
async function Reported2(credentials) {
  return fetch('http://49.0.64.71:32001/api/getAssetbyUserBranch', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json; charset=utf-8'
    },
...
async function Reported3(credentials) {
  return fetch('http://49.0.64.71:32001/api/wrongBranch', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json; charset=utf-8'
    },
