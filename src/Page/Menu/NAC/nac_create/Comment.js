...
async function stroe_FA_control_Path(credentials) {
  return fetch('http://49.0.64.71:32001/api/stroe_FA_control_Path', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json; charset=utf-8',
      'Accept': 'application/json'
...
async function qureyNAC_comment(credentials) {
  return fetch('http://49.0.64.71:32001/api/qureyNAC_comment', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json; charset=utf-8',
      'Accept': 'application/json'
...
async function qureyNAC_path(credentials) {
  return fetch('http://49.0.64.71:32001/api/qureyNAC_path', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json; charset=utf-8',
      'Accept': 'application/json'
